#ifndef SURFACE_MESH_DEFORMATION_H
#define SURFACE_MESH_DEFORMATION_H
...
class Surface_mesh_deformation : public Renderable
{
public:
    ...
    virtual ~Surface_mesh_deformation()
    {
        deleteVBO();
    }
...
#endif // SURFACE_MESH_DEFORMATION_H
